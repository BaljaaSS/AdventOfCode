...
numberList = np.genfromtxt("AdventOfCode/2020/Input/Input9.txt", usecols=0, usemask=False)
# %% Part-1
...
print("Part-2: A value in the accumulator is :", FindWeakness(invalidNumber, index))   